...
function normalized(data){ // i & r
    ...
    J = (data[4] - 0.777777778) / 0.415811905
    L = (data[5] - 0.5625) / 0.496164518
...
function ArgMax(res){
    label = "0|1|0" //POMPA OFF KIPAS OFF KRAN ON
    cls_data = []
    ...
    if(argMax(cls_data) == 1){
        ...
        label = "1|1|0" //POMPA ON KIPAS OFF KRAN ON
        ...
        label = "1|0|0" //POMPA OFF KIPAS OFF KRAN OFF
    }if(argMax(cls_data) == 7){
        label = "1|0|1" //POMPA OFF KIPAS ON KRAN OFF
    }
    return label
}
